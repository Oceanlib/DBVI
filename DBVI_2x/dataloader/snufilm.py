...
from configs.configTest import configMain
import pickle
import lmdb
...
class Test(data.Dataset):
    def __init__(self, cfg: configMain):
        ...
        if 'easy' in cfg.dataset:
            self.Sample = './datasets/snufilm/snufilm_lmdb/test-easy.pkl'  #310
        elif 'medium' in cfg.dataset:
            self.Sample = './datasets/snufilm/snufilm_lmdb/test-medium.pkl'  #310
        elif 'snufilm-hard' in cfg.dataset:
            self.Sample = './datasets/snufilm/snufilm_lmdb/test-hard.pkl'  #310
        else:
            self.Sample = './datasets/snufilm/snufilm_lmdb/test-extreme.pkl' #234

        self.LMDB = './datasets/snufilm/snufilm_lmdb/data.mdb'
