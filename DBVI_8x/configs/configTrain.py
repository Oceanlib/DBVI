...
class configMain(object):
    def __init__(self, gpuList=None, expName='Hyper'):
        ...
        self.resume = False
        self.visual = False
        self.dataset = 'GoPro'  # GoPro, X4K1000FPS
        self.expName = '8x_GoPro/' if self.resume else expName  # name of checkpoints dir
        self.preTrained = 'train_on_gopro_Iter0.pth' if self.resume else None  # name of pretrained weights
