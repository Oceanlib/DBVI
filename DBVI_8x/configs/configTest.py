...
class _Path(object):
    ...
    def __init__(self, resume=False, expName=None, cpkt=None):
        ...
        self.resume = resume
        # self.trainLMDB = './datasets/GoPro_public/lmdbOrg/train/data.mdb'
        # self.trainSample = './datasets/GoPro_public/lmdbOrg/train/sample.pkl'
        #
        # # self.testLMDB = './datasets/GoPro_public/lmdbOrg/test/data.mdb'
        # # self.testSample = './datasets/GoPro_public/lmdbOrg/test/sample.pkl'
        #
        # self.testLMDB = './datasets/X4K1000FPS/testlmdb/data.mdb'
        # self.testSample = './datasets/X4K1000FPS/testlmdb/sample.pkl'
...
class _Train(object):
    ...
    def __init__(self):
        ...
        self.batchPerGPU = 1 if _dist.isDist else 1  # large batch for sub dataset
