...
parser.add_argument('--expName', type=str, required=False, default='DBVI_8x', help='name of experiment')

args = parser.parse_args()
gpuList = ast.literal_eval(args.gpuList)

# import configs.configGoProInter7 as config
...
from lib.visualTool import saveTensor
...
class Trainer(object):
    def __init__(self, cfg: configMain):
        ...
        self.trainSampler, self.trainLoader = dataReader.creatTrainLoader(cfg)
